...
##################################################################
def load_audio_files(folder, sr):
    """Load all .wav files from a given folder."""
...
def main():
    ...
    parser.add_argument("--speech_folder", type=str, default="data/speech",
                        help="Folder containing speech .wav files")
    parser.add_argument("--music_folder", type=str, default="data/music",
                        help="Folder containing music .wav files")
    ...
    print(f"Found {len(speech_files)} speech files, {len(music_files)} music files, {len(mixture_files)} mixtures.")

    if not speech_files or not music_files or not mixture_files:
        raise RuntimeError("Please make sure you have .wav files in speech/music/mixture folders.")
